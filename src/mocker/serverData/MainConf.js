module.exports = {
    ...
    sub: [                      // 子菜单(二级菜单)
      {
        title: '子菜单1-1',      // 菜单名称
          ...
          sub:[
            {title: '子菜单1-1-1', component: 'SpreadExample', menuId: '1-1-1', icon: 'el-icon-menu'},
            {title: '子菜单1-1-2', component: 'FormExample', menuId: '1-1-2', icon: 'el-icon-menu'}
          ]
        },
  ...
  application: [
    ...
    },
    {
      title: '返回应用中心',        // 显示名称
      divided: true,              // 分割线
      url: 'http://kms.chamc.com.cn/WebPub/', // 跳转地址
