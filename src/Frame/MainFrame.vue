  ...
  <div class="indexWrap">
    ...
    <header class="topWrap">
      ...
      <div class="dsf">
        <!--logo 开始-->
        <div class="topLogo">
          <img class="topLogo-img" src="@/Images/ChamcLogo.png"/>
        </div>
        <!--logo 结束-->
        ...
        <div class="appName">
          <el-dropdown placement="bottom">
            <span class="appSelected">
              <i class="hx hx-hx_x-dengsikaotishifuben appNameIcon"></i>
            </span>
        ...
        <!--当前项目名称-->
        <div class="currentProjectName">风险报表数据报送</div>
      </div>

      <!--顶部栏 右侧-->
      <div class="dsf">
        <!--客户公司名称-->
        <div class="projectName">中国华融资产管理股份有限公司</div>
        <!--用户信息-->
